...
Github Actions now support OpenID Connect (OIDC) which provides the ability to get a short-lived token each time a Github Actions Workflow runs. This enables secure deployment of applications to the cloud.
